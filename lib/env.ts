...
export const env = createEnv({
  server: {
    ...
    WHOP_WEBHOOK_SIGNING_SECRET: z.string().optional(),
    GUMROAD_API_KEY: z.string().optional(),
    GUMROAD_CLIENT_ID: z.string().optional(),
    GUMROAD_CLIENT_SECRET: z.string().optional(),
    GUMROAD_REDIRECT_URI: z.string().url().optional(),
    PAYHIP_API_KEY: z.string().optional(),
    PAYHIP_WEBHOOK_SECRET: z.string().optional(),
    LULU_API_KEY: z.string().optional(),
    LULU_API_SECRET: z.string().optional(),
    // Phase 3: AI Layer
  ...
  runtimeEnv: {
    ...
    WHOP_WEBHOOK_SIGNING_SECRET: process.env.WHOP_WEBHOOK_SIGNING_SECRET,
    ...
    GUMROAD_REDIRECT_URI: process.env.GUMROAD_REDIRECT_URI,
    PAYHIP_API_KEY: process.env.PAYHIP_API_KEY,
    PAYHIP_WEBHOOK_SECRET: process.env.PAYHIP_WEBHOOK_SECRET,
    LULU_API_KEY: process.env.LULU_API_KEY,
    LULU_API_SECRET: process.env.LULU_API_SECRET,
